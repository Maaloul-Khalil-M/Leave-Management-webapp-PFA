...
public class _0002__SeedLeaveCatalog {
    ...
    public void rollback(MongoDatabase db) {
        db.getCollection("leave_policies")
          .deleteMany(new Document());
        db.getCollection("leave_types")
          .deleteMany(new Document());
    }
    ...
    private void seedLeaveTypes(MongoDatabase db) {
        ...
        col.insertMany(
                List.of(leaveType(LEAVE_TYPE_ANNUAL_ID, "PAID_ANNUAL", "Congé Payé",
                                  false, true, true, now),
                        leaveType(LEAVE_TYPE_SICK_ID, "SICK", "Congé Maladie", true,
                                  false, true, now),
    ...
    private void seedLeavePolicies(MongoDatabase db) {
        ...
        col.insertOne(new Document("_id", POLICY_TN_ANNUAL_ID).append("country", "TN")
                                                              .append("leaveTypeCode",
                                                                      "PAID_ANNUAL")
                                                              .append("accrualUnit",
                                                                      "WORKING_DAY")
        ...
        col.insertOne(new Document("_id", POLICY_TN_SICK_ID).append("country", "TN")
                                                            .append("leaveTypeCode",
                                                                    "SICK")
                                                            .append("accrualUnit",
                                                                    "CALENDAR_DAY")
        ...
        col.insertOne(new Document("_id", POLICY_TN_UNPAID_ID).append("country", "TN")
                                                              .append("leaveTypeCode",
                                                                      "UNPAID")
                                                              .append("accrualUnit",
                                                                      "WORKING_DAY")
        ...
        col.insertOne(new Document("_id", POLICY_TN_MATERNITY_ID).append("country", "TN")
                                                                 .append("leaveTypeCode",
                                                                         "MATERNITY")
                                                                 .append("accrualUnit",
                                                                         "CALENDAR_DAY")
        ...
        col.insertOne(new Document("_id", POLICY_FR_ANNUAL_ID).append("country", "FR")
                                                              .append("leaveTypeCode",
                                                                      "PAID_ANNUAL")
                                                              .append("accrualUnit",
                                                                      "WORKING_DAY")
        ...
        // FR SICK
        col.insertOne(new Document("_id", POLICY_FR_SICK_ID).append("country", "FR")
                                                            .append("leaveTypeCode",
                                                                    "SICK")
                                                            .append("accrualUnit",
                                                                    "CALENDAR_DAY")
        ...
        // FR UNPAID
        col.insertOne(new Document("_id", POLICY_FR_UNPAID_ID).append("country", "FR")
                                                              .append("leaveTypeCode",
                                                                      "UNPAID")
                                                              .append("accrualUnit",
                                                                      "WORKING_DAY")
        ...
        col.insertOne(new Document("_id", POLICY_FR_MATERNITY_ID).append("country", "FR")
                                                                 .append("leaveTypeCode",
                                                                         "MATERNITY")
                                                                 .append("accrualUnit",
                                                                         "CALENDAR_DAY")
    ...
    private static Document leaveType(String id, String code, String label,
        ...
        return new Document("_id", id).append("code", code)
                                      .append("label", label)
